...
void CMasternodeSync::ProcessTick(CConnman& connman)
{
    ...
    LogPrintf("CMasternodeSync::ProcessTick -- nTick %d %s nRequestedMasternodeAttempt %d nSyncProgress %f\n", nTick, GetAssetName(), nRequestedMasternodeAttempt, nSyncProgress);

...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "2. address      (string, required) The address to send the newly generated ORE to.\n"
...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "    https://github.com/galactrum/bips/blob/master/bip-0022.mediawiki\n"
            "    https://github.com/galactrum/bips/blob/master/bip-0023.mediawiki\n"
            "    https://github.com/galactrum/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
            "    https://github.com/galactrum/bips/blob/master/bip-0145.mediawiki\n"
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2) {
        throw std::runtime_error(
            ...
            "See https://en.galactrum.it/wiki/BIP_0022 for full specification.\n"
...
static UniValue setgenerate(const JSONRPCRequest& request)
{
    ...
    GenerateOREs(fGenerate, nGenProcLimit, Params(), *g_connman);

        ...
        if (item->checkState(COLUMN_CHECKBOX) == Qt::Unchecked)
            ...
            if (coinControl->fUsePrivateSend && nRounds < privateSendClient.nPrivateSendRounds) {
                QMessageBox::warning(this, windowTitle(),
                    tr("Non-anonymized input selected. <b>Cloaking will be disabled.</b><br><br>If you still want to use Cloaking, please deselect all non-nonymized inputs first and then check Cloaked checkbox again."),

...
QString BitcoinUnits::description(int unit)
{
    ...
    else
    {
        switch(unit)
        {
            case ORE: return QString("TestOREs");
            case mORE: return QString("Milli-TestORE (1 / 1" THIN_SP_UTF8 "000)");
            case uORE: return QString("Micro-TestORE (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case crag: return QString("Ten Nano-TestORE (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}

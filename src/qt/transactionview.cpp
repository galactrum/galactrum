    ...
    transactionView(0), abandonAction(0), bumpFeeAction(0), columnResizingFixer(0)
{
    ...
    typeWidget->addItem(tr("Minted(Stakenode)"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMintTPoS));
    typeWidget->addItem(tr("Minted(Stakenode Commission)"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMintTPoSCommission));

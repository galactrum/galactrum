    ...
    signalled(false)
{
    ...
    startThread();
    ui->buttonBox->button(QDialogButtonBox::Ok)->setIcon(QIcon(":/icons/light/synced"));
    ui->buttonBox->button(QDialogButtonBox::Ok)->setIconSize(QSize(32, 32));
    ui->buttonBox->button(QDialogButtonBox::Ok)->setObjectName(QStringLiteral("introOk"));
    ui->buttonBox->button(QDialogButtonBox::Cancel)->setIcon(QIcon(":/icons/light/cancel"));
    ui->buttonBox->button(QDialogButtonBox::Cancel)->setIconSize(QSize(32, 32));
    ui->buttonBox->button(QDialogButtonBox::Cancel)->setObjectName(QStringLiteral("introCancel"));
}
...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Galactrum"),
     ...
     * override -datadir in the galactrum.conf file in the default data directory
     * (to be consistent with galactrumd behavior)
     */

...
public:
    ...
    CAmount GetDustThreshold(const CFeeRate &minRelayTxFee) const
    {
        ...
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 1000 crag per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 crag.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in crag)
        // i.e. 182 * 3 = 546 crag with default -minrelaytxfee = minRelayTxFee = 1000 crag per kB.

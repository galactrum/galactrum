...
bool net_processing_galactrum::ProcessGetData(CNode *pfrom, const Consensus::Params &consensusParams, CConnman *connman, const CInv &inv)
{
...
void net_processing_galactrum::ProcessExtension(CNode *pfrom, const std::string &strCommand, CDataStream &vRecv, CConnman *connman)
{
...
void net_processing_galactrum::ThreadProcessExtensions(CConnman *pConnman)
{
...
bool net_processing_galactrum::AlreadyHave(const CInv &inv)
{
    switch(inv.type)
    {
    /*
...
bool net_processing_galactrum::TransformInvForLegacyVersion(CInv &inv, CNode *pfrom, bool fForSending)
{

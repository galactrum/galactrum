...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GalactrumNetwork") type = GalactrumNetwork;
    if(strType == "GalactrumNetworkVariable") type = GalactrumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GalactrumNetwork) s = "GalactrumNetwork";
    if(type == GalactrumNetworkVariable) s = "GalactrumNetworkVariable";

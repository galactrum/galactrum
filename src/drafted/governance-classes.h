 ...
 *
 *   // network
 *   CGalactrumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.galactrum.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGalactrumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CGalactrumNetwork(UniValue objIn)
    {
...
// // can be under: GalactrumNetwork
// //   -- signature requirements : Key1(User)
// class CGalactrumNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == GalactrumNetwork);
//     // }

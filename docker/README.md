...
official/supported Docker Images found at https://hub.docker.com/r/galactrum/galactrumd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/galactrum/galactrumd-develop/ when changing the above text**
...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid galactrum address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid galactrum address" in e.error['message'])

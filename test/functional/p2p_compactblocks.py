...
# TestP2PConn: A peer we use to send messages to galactrumd, and store responses.
...
class CompactBlocksTest(GalactrumTestFramework):
    ...
    # This test actually causes galactrumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that galactrumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for galactrumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # galactrumd will not send blocktxn responses for blocks whose height is

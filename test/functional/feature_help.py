...
"""Verify that starting galactrum with -h works as expected."""
import subprocess

from test_framework.test_framework import GalactrumTestFramework
from test_framework.util import assert_equal

class HelpTest(GalactrumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start galactrum with -h for help text")
        ...
        self.log.info("Start galactrum with -version for version information")

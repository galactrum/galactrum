...
class FullBlockTest(GalactrumTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure galactrumd isn't accepting b26
        ...
        # Extend the b28 chain to make sure galactrumd isn't accepting b28
        ...
        # galactrumd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the galactrum code has custom code which does so);

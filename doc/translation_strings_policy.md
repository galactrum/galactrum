...
This document provides guidelines for internationalization of the Galactrum software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `galactrum_en.ts` remains unchanged.

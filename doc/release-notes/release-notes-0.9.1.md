Galactrum version 0.9.1 is now available from:

  https://galactrum.org/bin/0.9.1/
...
galactrumd from any pre-0.9.1 version, and have enabled SSL for RPC and

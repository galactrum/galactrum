Galactrum version 0.14.2 is now available from:

  <https://galactrum.org/bin/galactrum-core-0.14.2/>
...
(in Galactrum 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Galactrum-Qt when using coin
...
- #10228 `ae479bc` Regenerate galactrum-config.h as necessary (theuni)

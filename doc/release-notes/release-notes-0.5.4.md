Galactrum version 0.5.4 is now available for download at:
http://sourceforge.net/projects/galactrum/files/Galactrum/galactrum-0.5.4/
...
http://gitorious.org/galactrum/galactrumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Galactrum-Qt notifications under Growl 1.3.
Increase required age of Galactrum-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGalactrum properly when installing Galactrum-Qt over it. (Windows)

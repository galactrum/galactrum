Galactrum version 0.11.2 is now available from:

  <https://galactrum.org/bin/galactrum-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include galactrum-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split galactrum-tx into its own package

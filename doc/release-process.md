...
* Update translations, see [translation_process.md](https://github.com/galactrum/galactrum/blob/master/doc/translation_process.md#synchronising-translations).
...
* Update hardcoded [seeds](/contrib/seeds/README.md). TODO: Give example PR for Galactrum
...
### Galactrum maintainers/release engineers, update (commit) version in sources
...
### Build and sign Galactrum for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit galactrum=v${VERSION} ../galactrum/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit galactrum=v${VERSION} ../galactrum/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit galactrum=v${VERSION} ../galactrum/contrib/gitian-descriptors/gitian-osx.yml
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import galactrum/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
- Detached signatures will then be committed to the [galactrum-detached-sigs](https://github.com/galactrum/galactrum-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the galactrum.org server*.
...
- Update galactrum.org

- Announce the release:

  - Release on forums, Discord, twitter, reddit /r/galactrum, ... but this will usually sort out itself

  - Update any package distribution systems (Debian, Arch, etc)
